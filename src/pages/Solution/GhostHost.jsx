    ...
    <>
      <div className="bg-[#080617]">
        <div className="relative w-full h-fit md:h-auto overflow-hidden bg-[#080617] ">
          {/* Background Text */}
          <h1 className="absolute w-full text-center text-white md:text-[150px] lg:text-[200px] xl:text-[250px] 2xl:text-[384px] lg:leading-[307px] font-bold">
            GhostHost
          </h1>
          ...
          {/* Content */}
          <div className="absolute flex justify-start w-full flex-col bottom-10 left-1/2 transform -translate-x-1/2  px-4 sm:px-6 lg:px-8">
